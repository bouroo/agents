...
- **Repo docs** (system-explanation layer): [docs/](docs/README.md) -- how the squad and the distribution layer work; see [multi-host install](docs/flows/multi-host-install-and-discovery.md) and [ADR 0001](docs/architecture/decisions/0001-native-per-host-artifact-format.md).
