...
- **Repo documentation system** (bootstraps a `docs/` tree into a *target* repo): [repo-documentation](skills/repo-documentation/SKILL.md) skill + [document](commands/document.md) command. This config repo documents itself via `AGENTS.md` + skills; it does not ship its own `docs/` tree.
