...
- **Completion-audit** every "done" against the actual current state before converging (see [completion-audit](../references/orchestrator/completion-audit.md)).
...
- See [failure classes and convergence gates](../references/orchestrator/plan-and-convergence.md) when a turn fails or before issuing a final verdict.

## References

- [Plan Mode, convergence gates, failure classes, state schema](../references/orchestrator/plan-and-convergence.md)
- [Completion audit, autonomy, capability/effort dial](../references/orchestrator/completion-audit.md)
