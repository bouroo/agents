...
- [plan-authoring](../plan-authoring/SKILL.md) plans carry the judgment contract: DONE_WHEN lists the checks a judge re-runs; status entries owe this skill's evidence standard.
