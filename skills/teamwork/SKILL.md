...
- [wayfinder](../wayfinder/SKILL.md) when the effort itself outgrows one session: the map of decision tickets is the cross-session counterpart of this ledger, which coordinates agents within one job.
