...
- Arrange code to explain itself: clear names, short functions, and named helpers carry intent so the reader rarely needs prose. Reserve comments for the *why* that the code cannot show — non-obvious rationale, constraints, or history.
