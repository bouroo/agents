...
$ARGUMENTS (positional: `$1` = project path or brief; default: current directory).
...
4. **Update existing AGENTS.md** — preserve structure, merge changes, do not overwrite unless the brief says to.
