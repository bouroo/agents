...
4. **Hunt the fraud table.** The frauds live in [validator verification-and-verdict](../references/validator/verification-and-verdict.md); do not re-derive them. Hunt highest-yield first and resolve authority by rank. See [judge protocol](cmd-judge/references/judge-protocol.md) for the full hunt order and output template.
...
- [validator verification-and-verdict](../references/validator/verification-and-verdict.md) the fraud rubric table.
