---
description: "Bootstrap or sync a repo's docs/ tree (systems, flows, ADRs, glossary) with code changes. Use when a behavior, interface, invariant, or domain-term change must be reflected in project documentation."
agent: coder
phase: ACT
---
...
3. **Locate.** Read `AGENTS.md` and/or `docs/README.md` for the docs map. Find the affected system doc (`docs/systems/`), related flows (`docs/flows/`), governing ADRs (`docs/architecture/decisions/`), and Title Case terms in `docs/glossary.md`. If no doc exists, decide whether the area warrants one.
4. **Choose type.** Pick exactly one: system / flow / ADR / glossary. Choose from the skill, not memory; resist inventing categories.
...
- Templates (copied into `docs/templates/`): [system.md](../skills/repo-documentation/references/system.md) | [flow.md](../skills/repo-documentation/references/flow.md) | [adr.md](../skills/repo-documentation/references/adr.md).
